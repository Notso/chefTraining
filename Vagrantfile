...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "notso-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/notso"
  #   chef.validation_client_name = "notso-validator"
  #   chef.validation_key_path = ".chef/notso-validator.pem"
  # end
end
